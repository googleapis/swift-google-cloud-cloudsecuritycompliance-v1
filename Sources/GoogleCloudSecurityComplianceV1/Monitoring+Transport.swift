  ...
  final class MonitoringTransport: MonitoringStub {
    ...
    public func listFrameworkComplianceSummaries(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/frameworkComplianceSummaries"
      }()
      var query = [
    ...
    public func listFindingSummaries(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/findingSummaries"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func listControlComplianceSummaries(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/controlComplianceSummaries"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func aggregateFrameworkComplianceReport(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):aggregate"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
