...
extension Clients {
  final class CmEnrollmentServiceLogging: CmEnrollmentServiceStub {
    let inner: any CmEnrollmentServiceStub
    let logger: Logger

    public init(_ inner: any CmEnrollmentServiceStub, logger: Logger) {
      var logger = logger
      ...
      logger[metadataKey: "gcp.experimental.swift.client"] = "CmEnrollmentService"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func updateCmEnrollment(
      ...
      try await self._intercept(
        request: request,
        options: options,
        name: "updateCmEnrollment",
        action: {
          (r: UpdateCmEnrollmentRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudSecurityComplianceV1.CmEnrollment
          in
          return try await self.inner.updateCmEnrollment(request: r, options: o)
        })
    }
    ...
    public func calculateEffectiveCmEnrollment(
      ...
      try await self._intercept(
        request: request,
        options: options,
        name: "calculateEffectiveCmEnrollment",
        action: {
          (r: CalculateEffectiveCmEnrollmentRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudSecurityComplianceV1.CalculateEffectiveCmEnrollmentResponse
          in
          return try await self.inner.calculateEffectiveCmEnrollment(request: r, options: o)
        })
    }
