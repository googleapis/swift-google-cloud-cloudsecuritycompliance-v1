...
extension Clients {
  class CmEnrollmentServiceTransport: CmEnrollmentServiceStub {
    ...
    public func updateCmEnrollment(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.cmEnrollment.map({ $0.name }), !pathVariable0.isEmpty
        else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.cm_enrollment.name' is not set or is empty")
        }
    ...
    public func calculateEffectiveCmEnrollment(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):calculate"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
